  ...
  return (
    <section className="py-32 bg-[url('https://images.unsplash.com/photo-1542751371-adc38448a05e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center relative bg-fixed">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
        ...
        {loading ? (
          <div className="px-10 py-5 bg-primary/50 text-white font-bold text-lg tracking-widest opacity-50 cursor-wait skew-x-[-15deg]">
            <div className="skew-x-[15deg]">LOADING...</div>
          </div>
        ) : (
          <Link
            to={user ? "/tournament" : "/register"}
          ...
          >
            ...
            <div className="skew-x-[15deg]">{user ? "REGISTER YOUR TEAM" : "CREATE AN ACCOUNT"}</div>
          </Link>
        )}
      </div>
    </section>
